...
public class mainPage extends Page {
    ...
    // private arraylist<recipe> recipes; which has all the recipes and we use it to
    // sort
    public mainPage(int width, int height) {
        ...
        // RecipeTitleView recipeTitleView = new RecipeTitleView(recipe); //<-- This
        // should be UI
    ...
    public void sortBoxClick(String selectedOption) {
        ...
        // do a switch case to check between "Newest to Oldest", "Oldest to Newest", "A
        // to Z", "Z to A"
    ...
    protected void createView() {
        ...
        sortBox.setOnAction(e -> {
            ...
            // // do a switch case to check between "Newest to Oldest", "Oldest to Newest",
            // "A to Z", "Z to A"
            // switch(selectedOption) {
            // case "Newest to Oldest":
            // // sort by newest to oldest
        ...
        /*
         * Create the pageSettings subheader for adding the two drop downs and the
         * signout option
         */
        ...
        // pageSettings.setMargin(signOutButton, new Insets(0, 0, 0, 10)); // Add margin
        // to the right button
