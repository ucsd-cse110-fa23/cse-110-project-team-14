...
public class Sort {
    ...
    public ArrayList<Recipe> newToOldSort(ArrayList<Recipe> recipes) {
    ...
    public ArrayList<Recipe> oldToNewSort(ArrayList<Recipe> recipes) {
        Comparator<Recipe> comparator = new Comparator<Recipe>(){
            @Override
            public int compare(Recipe r1, Recipe r2) {
                if (r1.getRecipeIndex() < (r2.getRecipeIndex())) {
    ...
    public ArrayList<Recipe> aToZSort(ArrayList<Recipe> recipes) {
        Comparator<Recipe> comparator = new Comparator<Recipe>(){
            @Override
            public int compare(Recipe r1, Recipe r2) {
    ...
    public ArrayList<Recipe> zToASort(ArrayList<Recipe> recipes) {
        Comparator<Recipe> comparator = new Comparator<Recipe>(){
            @Override
            public int compare(Recipe r1, Recipe r2) {
                String recipeName1 = r1.getRecipeTitle();
